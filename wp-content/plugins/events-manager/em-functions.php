...
function em_get_currencies(){
    ...
    $currencies->names = array(
        ...
        'ZAR' => 'ZAR - South African Rand' // <-- Added ZAR here
    );
    ...
    $currencies->symbols = array(
        ...
        'TRY' => 'TL',
        'RUB' => '&#8381;',
        'ZAR' => 'R' // <-- Added ZAR symbol here
    );

    $currencies->true_symbols = array(
        'EUR' => '€',
        'USD' => '$',
        'GBP' => '£',
        'CAD' => '$',
        ...
        'TRY' => 'TL',
        'RUB' => '₽',
        'ZAR' => 'R' // <-- Added true symbol for ZAR here
    );
